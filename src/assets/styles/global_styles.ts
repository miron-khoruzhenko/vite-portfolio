const 
			sectionHeading = 'text-center text-3xl font-bold dark:text-zinc-100 mb-12 relative ',
...
const 
			leftBefore =  "before:block before:h-px before:w-36 before:bg-zinc-300 before:dark:bg-zinc-800 before:my-4 before:mx-auto before:rounded-full before:absolute before:-bottom-9 before:left-0 ",
