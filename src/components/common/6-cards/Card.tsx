...
const Card = (props : CardProps) => {
	...
	const styles = {
		...
		cardColors: 'bg-zinc-200 dark:bg-zinc-800 shadow-lg ',
		movingContainer: 'transition-transform group-hover:-translate-y-2  ',
		...
		desc: "text-zinc-600 dark:text-zinc-400 text-md mb-4",
	}
