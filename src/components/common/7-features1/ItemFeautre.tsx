...
const styles = {
	...
	icon : "bg-blue-800/80 group-hover:bg-blue-800 dark:bg-violet-600 transition-colors text-white aspect-square w-10 rounded-md flex items-center justify-center",
